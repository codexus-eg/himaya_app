          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                ImeiField(controller: imeiCtrl, decoration: InputDecoration(labelText: tr('cl_imei'))),
                const SizedBox(height: 10),
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: saving ? null : () async {
                        ...
                        if (canChangeRole && selectedRole != widget.user.accountType) {
                          ...
                          if (rr['success'] != true) roleErr = rr['error'] as String? ?? tr('cl_fail');
                        }
                        ...
                        if (ctx.mounted) {
                          Navigator.pop(ctx);
                          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                            content: Text((r['success'] == true && roleErr == null)
                                    ? tr('cl_settings_saved')
                                    : (roleErr ?? r['error'] ?? tr('cl_fail')),
                                style: const TextStyle(fontFamily: 'Cairo')),
                            backgroundColor: (r['success'] == true && roleErr == null) ? const Color(0xFF6BA539) : const Color(0xFFC41E3A),
                          ));
                ...
                Padding(padding: const EdgeInsets.fromLTRB(12, 6, 12, 12), child: Row(children: [
                  ...
                  ElevatedButton(
                    onPressed: (sending || targets.isEmpty) ? null : () async {
                      ...
                      String? sendErr;
                      try {
                        final r = await ApiService.request('send_broadcast', all
                      ...
                      if (ctx.mounted) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                          content: Text(sentOk ? tr('bc_sent') : (sendErr ?? tr('cl_fail')),
                              style: const TextStyle(fontFamily: 'Cairo')),
                          backgroundColor: sentOk ? const Color(0xFF6BA539) : const Color(0xFFC41E3A),
                        ));
                      }
                    },
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _loadRecent() async {
    ...
    if (mounted) setState(() { _recentUsernames = list; _recentPw = pw; });
  }
                          ...
                          suffixIcon: _recentUsernames.isEmpty
                              ...
                              : PopupMenuButton<String>(
                                  ...
                                  onSelected: (u) {
                                    ...
                                    if (saved != null && saved.isNotEmpty) _login();
                                  },
